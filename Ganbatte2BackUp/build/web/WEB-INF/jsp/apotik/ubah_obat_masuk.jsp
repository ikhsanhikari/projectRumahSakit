<%-- 
    Document   : ubah_obat_masuk
    Created on : Aug 30, 2017, 5:07:57 PM
    Author     : hikari
--%>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="obatMasukDto" class="form-validate form-horizontal "  method="POST" id="formData" action="updateObatMasuk.htm">
                                            <form:hidden path="id_obat_masuk"/>
                                            ...
                                            <div class="form-group ">
                                                <label class="control-label col-lg-2">Tanggal obat Masuk <span class="required">*</span></label>
                                                <div class="col-lg-10">
                                                    <form:input style="width:300px;height:30px"  path="tgl_obat_masuk" class="form-control"  required="required" type="text" />
                                                </div>
                                            </div> 
                                            <div class="form-group ">
