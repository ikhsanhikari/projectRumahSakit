<%-- 
    Document   : formTambahTindakan
    Created on : Sep 14, 2017, 8:45:33 AM
    Author     : hikari
--%>
            ...
            <section class="wrapper">
                ...
                <div class="row">
                                    <div class="panel-body">
                                        <div class="form">
                                            <form:form modelAttribute="tindakanDto" class="form-validate form-horizontal "  method="POST" id="formData" action="saveTindakan.htm">
                                                <form:hidden path="id_klinik" value="${listKlinik.id_klinik}"/>
                                                <form:hidden path="id_pasien" value="${listKlinik.id_pasien}"/>
                                                <div class="form-group ">
                                                    <label class="control-label col-lg-2">tindakan <span class="required">*</span></label>
                                                    <div class="col-lg-10">
                                                        <form:input  style="width:300px;height:30px;border-radius:0px;"  path="nama_tindakan"  class="validate validate[required] form-control"  required="required" />
                                                    </div>
                                                </div>                                                 
                                        </div><br>
                                            <div class="form-group">
