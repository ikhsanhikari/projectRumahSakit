<%-- 
    Document   : formObatKeluarPasien
    Created on : Sep 13, 2017, 10:16:42 AM
    Author     : hikari
--%>
            ...
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="panel-body">
                        <div class="form">
                            <form:form modelAttribute="obatKeluarDto" class="form-validate form-horizontal "  method="POST" action="saveObatKeluarPasien.htm">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <form:select style="width:300px;height:30px"  path="id_obat" class="form-control"  required="required"  >
                                    ...
                                    <div class="form-group ">
                                    <label class="control-label col-lg-2">Jumlah <span class="required">*</span></label>
                                    <div class="col-lg-10">
                                        <form:input style="width:300px;height:30px;border-radius:0px;"  path="jumlah_obat_keluar" class="validate validate[required] form-control" required="required" />
                                    </div>
                                </div>
                            </div><br>
                            <div class="form-group">
