<%-- 
    Document   : tambah_jenis_klinik
    Created on : Aug 19, 2017, 10:12:18 AM
    Author     : hikari
--%>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="jenisKlinikDto" class="form-validate form-horizontal "  method="POST" id="formData" action="saveJenisKlinik.htm">
