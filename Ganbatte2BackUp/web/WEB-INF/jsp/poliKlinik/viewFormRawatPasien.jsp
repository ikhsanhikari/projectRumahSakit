<%-- 
    Document   : viewFormRawatPasien
    Created on : Sep 5, 2017, 6:36:06 PM
    Author     : hikari
--%>
                          ...
                          <div class="col-lg-6 panel">
                              ...
                              <div class="row">
                                  <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="klinikDto" class="form-validate form-horizontal "  method="GET" id="formData" action="updateIdKlinik.htm">
