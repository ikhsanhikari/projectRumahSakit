<%-- 
    Document   : tambah_obat_keluar
    Created on : Aug 28, 2017, 10:56:18 PM
    Author     : hikari
--%>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="obatKeluarDto" class="form-validate form-horizontal "  method="POST" action="saveObatKeluar.htm">
