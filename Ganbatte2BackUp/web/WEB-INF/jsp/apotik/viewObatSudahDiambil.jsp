<%-- 
    Document   : viewObatSudahDiambil
    Created on : Sep 21, 2017, 8:28:55 AM
    Author     : sou
--%>
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">            
                    ...
                    <!-- page start-->
                    <a class="btn btn-success" href="viewObatKeluar.htm"><i class="fa fa-hand-o-down"></i> Ambil obat lagi</a> <br><br>
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
