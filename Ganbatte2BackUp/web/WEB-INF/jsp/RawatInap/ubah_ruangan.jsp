<%-- 
    Document   : ubah_ruangan
    Created on : Aug 28, 2017, 12:39:08 AM
    Author     : hikari
--%>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="ruanganDto" class="form-validate form-horizontal "  method="POST" id="formData" action="ubahRuangan.htm">
                                            <form:hidden path="id_ruangan"/>
