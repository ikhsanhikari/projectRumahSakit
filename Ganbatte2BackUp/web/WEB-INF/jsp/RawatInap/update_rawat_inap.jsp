<%-- 
    Document   : update_rawat_inap
    Created on : Aug 27, 2017, 5:29:14 AM
    Author     : hikari
--%>
                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="form">
                                        <form:form modelAttribute="rawatInapDto" class="form-validate form-horizontal "  method="POST" id="formData" action="updateRawatInap.htm">
                                            <form:hidden path="id_rawat_inap"/>
                                            <div class="form-group ">
                                                <label class="control-label col-lg-2">Nama Pasien <span class="required">*</span></label>
                                                <div class="col-lg-10">
                                                    <form:select style="width:300px;height:30px"  path="id_pasien" class="form-control"   >
                                                        <option  selected="true" value="${rawatInapDto.id_pasien}">${rawatInapDto.id_pasien}</option>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-10">
                                                    <form:select style="width:300px;height:30px"  path="id_nomor_ruangan" class="validate validate[required] form-control" id="nama"  type="text" >
                                                        <option  selected="true" value="${rawatInapDto.id_nomor_ruangan}">${rawatInapDto.id_nomor_ruangan}</option>
                                            ...
                                            <div class="form-group ">
                                                <label class="control-label col-lg-2">Tanggal Masuk <span class="required">*</span></label>
                                                <div class="col-lg-10">
                                                    <form:input style="width:300px;height:30px"  path="tgl_masuk" class="validate validate[required] form-control" id="nama" name="fullname" required="required" type="text" />
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label class="control-label col-lg-2">Tanggal Keluar <span class="required">*</span></label>
                                                <div class="col-lg-10">
                                                    <form:input style="width:300px;height:30px"  path="tgl_keluar" class="validate validate[required] form-control"  required="required" type="text" />
                                                </div>
                                            </div>
